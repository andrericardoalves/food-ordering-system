...
import com.food.ordering.kafka.consumer.KafkaConsumer;
        ...
        messages.forEach(restaurantApprovalResponseAvroModel -> {
           try {
               if (OrderApprovalStatus.APPROVED == restaurantApprovalResponseAvroModel.getOrderApprovalStatus()) {
                   ...
                   log.info("Processing reject order for order id: {}, with failure messages: {}",
                           restaurantApprovalResponseAvroModel.getOrderId(),
               ...
               //NO-OP for optimistic lock. This means another thread finished the work, not throw error to prevent
